...
{
    [DbContext(typeof(BizReadOnlyContext))]
    [Migration("20191213064642_IniDB-201912131444")]
    partial class IniDB201912131444
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TEG.SSO.Entity.DBModel.RoleRight", b =>
                {
                    b.HasOne("TEG.SSO.Entity.DBModel.AuthorizationObject")
                        .WithMany("RoleRights")
                        .HasForeignKey("AuthorizationObjectID");

                    b.HasOne("TEG.SSO.Entity.DBModel.Menu")
                        .WithMany("RoleRights")
                        .HasForeignKey("MenuID");
